...
def minimax(agentIndex, depth, gameState, max_depth):
    ...
    if agentIndex == 0:
        ...
        for action in getObservation(agents[agentIndex].get_pos(), new_state.wall, ghost_pos):
            ...
            value = max(value, minimax(1, depth, new_state, max_depth))
        ...
        value = min(value, minimax(nextAgent, depth, new_state, max_depth))
        return value
        ...
        if not victory_check and not lost_check:
            ...
            if agentIndex == 0:
                ...
                for action in PosibleActions:
                    ...
                    action_scores.append(minimax(1, 0, state_recusive, max_depth))
